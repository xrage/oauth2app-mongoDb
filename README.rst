...
"Oauth2app for Norel (MongoDb)"

Its a fork of hiidefs oauth2app. so his documentaion is still valid . You can visit-

* http://hiidef.github.com/oauth2app for documentation.
...
If easy_install is available, you can use: ::
    ...
    easy_install https://github.com/dkvermavit/oauth2app-mongoDb/tarball/master
...
An `example Django project <https://github.com/dkvermavit/oauth2app-mongoDb/tree/master/examples/mysite>`_ demonstrating client and server functionality is available in the repository.

https://github.com/dkvermavit/oauth2app-mongoDb/tree/master/examples/mysite
